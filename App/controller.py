...
def req_5(control, nombre, fecha_inicio, fecha_final):
    ...
    """
    periodo,total_scorers,total_anotaciones_jugador,total_penalty,total_autogol = model.req_5(control["model"], nombre, fecha_inicio, fecha_final)
    ...
    return respuesta, total_scorers,total_anotaciones_jugador,total_penalty,total_autogol 
